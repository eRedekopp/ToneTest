...
public class SingleSineConfidenceTest extends ConfidenceTest<FreqVolPair> {
    ...
    protected void configureTestPairs(int trialsPerTone, int volsPerFreq, float[] frequencies) {
        ...
        testPairs.add(new FreqVolPair(      // add a test that will likely be heard every time
                confFreqs.get(0),
        ...
        if (this.testPairs.size() != trialsPerTone * frequencies.length * volsPerFreq)
